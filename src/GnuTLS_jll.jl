...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GnuTLS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0951126a-58fd-58f1-b5b3-b08c7c4a876d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "GnuTLS", artifacts_toml) for e in artifacts["GnuTLS"]]
...
if best_platform === nothing
    @debug("Unable to load GnuTLS; unsupported platform $(triplet(platform_key_abi()))")
else
